...
export default function Page() {
  ...
  const rows: Row[] = useMemo(() => {
          ...
          ([
            ...
            data.profile.contact?.linkedin
              ? {
                  ...
                  image: "/placeholder.svg?height=900&width=600",
                  description: "Connect with Asim on LinkedIn for professional networking.",
                }
              : null,
            data.profile.contact?.github
              ? {
                  ...
                  image: "/placeholder.svg?height=900&width=600",
                  description: "Explore Asim's open-source projects and contributions.",
                }
              : null,
            data.profile.contact?.resume
              ? {
                  ...
                  image: "/placeholder.svg?height=900&width=600",
                  description: "Download Asim's latest CV and professional experience.",
                }
              : null,
    ...
    return [
      ...
      { id: "connect", title: "Connect with Asim", anchor: "contact", items: connectItems },
    ]
  }, [data, mediumPosts])
